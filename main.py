...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='PU', type=str, help='dataset name : IP, PU, SA, KSC')
    parser.add_argument('--train_size', default=16, type=int, help='train batch_size')
    parser.add_argument('--test_size', default=1000, type=int, help='test batch_size')
    parser.add_argument('--kernel_size', default=3, type=int, help='kernel_size ')
    parser.add_argument('--depth', default=8, type=int, help='IP、KSC:32 UP:8 ')
